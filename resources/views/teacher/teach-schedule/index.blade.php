    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        function renderCalendarWithEvents(date, eventsByDay) {
            ...
            for (let i = 1; i <= daysInMonth; i++) {
                ...
                dayEvents.sort((a, b) => a.time_start.localeCompare(b.time_start)); // 🕐 sắp xếp theo giờ tăng dần
                ...
                if (dayEvents.length > 2) {
                    ...
                    moreEl.addEventListener("click", () => {
                        ...
                        dayEvents.forEach(ev => {
                            ...
                            if (eventDate >= today) {
                                // ❌ Ca học tương lai: disable click
                                div.classList.add("disabled-event");
                                div.style.pointerEvents = "none";
                                div.style.opacity = "0.5";
                                div.title = "Chưa đến ngày học";
                            } else {
                                // ✅ Ca học hôm nay hoặc đã qua: cho click
                                div.addEventListener("click", () => {
                                    window.location.href =
                                        `${window.BASE_URL}/teacher/class-details/${ev.class_id}?date=${ev.date}`;
                                });
